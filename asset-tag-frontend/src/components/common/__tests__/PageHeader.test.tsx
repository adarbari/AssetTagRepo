    ...
    it('should work with all props together', async () => {
      ...
      render(
        <PageHeader 
          ...
          onBack={mockOnBack}
          actions={
            <button onClick={mockAction}>Complete Action</button>
          }
        />
      )
      ...
      const backButton = screen.getByRole('button', { name: /back/i })
      const actionButton = screen.getByRole('button', { name: /complete action/i })
    ...
    it('should support keyboard navigation', async () => {
      ...
      render(
        <PageHeader 
          ...
          onBack={mockOnBack}
          actions={
            <button onClick={mockAction}>Test Action</button>
          }
        />
      )
