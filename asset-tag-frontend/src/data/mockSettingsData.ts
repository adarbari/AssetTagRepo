...
export async function updateSystemPreferences(updates: Partial<SystemPreferences>): Promise<SystemPreferences> {
  await new Promise(resolve => setTimeout(resolve, 200));
...
export async function updateIntegrationSettings(updates: Partial<IntegrationSettings>): Promise<IntegrationSettings> {
  await new Promise(resolve => setTimeout(resolve, 200));
...
export async function updatePaymentMethod(paymentMethod: BillingInfo["paymentMethod"]): Promise<BillingInfo> {
  await new Promise(resolve => setTimeout(resolve, 200));
  return { ...billingInfo, paymentMethod };
}

export async function changePlan(plan: BillingInfo["plan"], billingCycle: BillingInfo["billingCycle"]): Promise<BillingInfo> {
  await new Promise(resolve => setTimeout(resolve, 200));
