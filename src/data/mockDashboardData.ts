...
export interface RecentActivity {
  id: string;
  type: "asset_movement" | "geofence_violation" | "battery_low" | "maintenance_due" | "alert_triggered";
  asset: string;
  assetId: string;
  description: string;
  time: string;
 ...
 */
export async function getLocationData(timeRange: '24h' | '7d' | '30d' = '24h'): Promise<LocationDataPoint[]> {
  await new Promise(resolve => setTimeout(resolve, 100));
  return locationData;
}
