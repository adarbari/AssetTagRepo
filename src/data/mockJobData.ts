...
export const mockJobs: Record<string, Job> = {
  ...
  "job-5": {
    ...
    description: "Replacement of 15-year-old HVAC system across 3 floors of commercial office building.",
    siteId: "site-5",
    ...
    createdBy: "user-admin",
    notes: "ON HOLD: Client delayed due to permit issues. Expected to resume week of 10/21.",
  ...
  "job-6": {
    ...
    description: "Complete tear-out and repaving of 120-space parking lot including new striping and lighting upgrades.",
    siteId: "site-6",
    ...
    createdBy: "user-admin",
    notes: "Work restricted to overnight hours 10 PM - 6 AM to minimize customer disruption.",
  ...
  "job-7": {
    ...
    description: "Annual safety inspection and minor concrete repair work on County Road 12 bridge over Clearwater River.",
    siteId: "site-7",
    ...
    createdBy: "user-admin",
    notes: "Requires certified bridge inspector on site. Lane closure permits obtained for 10/20-10/22.",
  ...
  "job-8": {
    ...
    description: "Debris removal and emergency tree trimming following severe storm damage across industrial park.",
    siteId: "site-8",
    ...
    notes: "Emergency response. Completed within 4 days. Minor budget overrun approved by client.",
...
export function getJobStatistics() {
  ...
  const totalActualCosts = jobs.reduce((sum, job) => sum + job.actualCosts.total, 0);
