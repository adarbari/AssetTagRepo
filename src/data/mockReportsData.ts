...
export const costSavingsData: CostSavingsData[] = [
  { month: "Jan", theftPrevention: 12000, laborSaved: 8500, insurance: 3200, maintenanceSavings: 4200 },
  { month: "Feb", theftPrevention: 15000, laborSaved: 9200, insurance: 3200, maintenanceSavings: 3800 },
  { month: "Mar", theftPrevention: 8000, laborSaved: 10100, insurance: 3200, maintenanceSavings: 5100 },
  { month: "Apr", theftPrevention: 22000, laborSaved: 9800, insurance: 3200, maintenanceSavings: 4500 },
  { month: "May", theftPrevention: 5000, laborSaved: 11200, insurance: 3200, maintenanceSavings: 4800 },
  { month: "Jun", theftPrevention: 18000, laborSaved: 12400, insurance: 3200, maintenanceSavings: 5200 },
  { month: "Jul", theftPrevention: 13000, laborSaved: 11800, insurance: 3200, maintenanceSavings: 4900 },
  { month: "Aug", theftPrevention: 9000, laborSaved: 10500, insurance: 3200, maintenanceSavings: 4300 },
  { month: "Sep", theftPrevention: 16000, laborSaved: 9900, insurance: 3200, maintenanceSavings: 4600 },
  { month: "Oct", theftPrevention: 11000, laborSaved: 13100, insurance: 3200, maintenanceSavings: 5400 },
  { month: "Nov", theftPrevention: 19000, laborSaved: 12700, insurance: 3200, maintenanceSavings: 5100 },
  { month: "Dec", theftPrevention: 14000, laborSaved: 11500, insurance: 3200, maintenanceSavings: 4700 },
];
 ...
 */
export async function getCostSavingsData(months: number = 6): Promise<CostSavingsData[]> {
  await new Promise(resolve => setTimeout(resolve, 100));
...
export function calculateTotalROI(data: CostSavingsData[]): number {
  return data.reduce((total, month) => {
    return total + month.theftPrevention + month.laborSaved + month.insurance + month.maintenanceSavings;
  }, 0);
}
