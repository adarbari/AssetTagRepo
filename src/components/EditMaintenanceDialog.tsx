...
interface EditMaintenanceDialogProps {
  ...
  onSave?: (taskId: string, changes: Array<{ field: string; from: string; to: string }>, notes: string) => void;
}
...
export function EditMaintenanceDialog({
  ...
  const handleSubmit = () => {
    ...
    // Track changes
    const newType = maintenanceType.charAt(0).toUpperCase() + maintenanceType.slice(1);
    ...
    const newDate = scheduledDate ? format(scheduledDate, "yyyy-MM-dd") : task.dueDate;
    ...
    if (newAssignedTo !== task.assignedTo) {
      changes.push({ field: "Assigned To", from: task.assignedTo, to: newAssignedTo });
    }
    
    if (description !== task.task) {
      changes.push({ field: "Task Description", from: task.task, to: description });
    }
            ...
            <div className="space-y-2">
              ...
              <Select value={maintenanceType} onValueChange={setMaintenanceType}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="cleaning">Cleaning & Lubrication</SelectItem>
                </SelectContent>
              </Select>
            </div>
        ...
        <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
          <div className="flex items-start gap-2">
            ...
            <p className="text-sm text-blue-900">
              All changes to this maintenance task will be automatically logged in the audit trail with your user information and timestamp.
            </p>
          </div>
        </div>
