...
describe('Badge Component - Click Tests', () => {
  ...
  describe('Interactive Badge (asChild)', () => {
    it('should handle click on badge button', async () => {
      ...
      const badgeButton = screen.getByRole('button', { name: /clickable badge/i })
    ...
    it('should handle multiple clicks on badge button', async () => {
      ...
      const badgeButton = screen.getByRole('button', { name: /multi click badge/i })
    ...
    it('should handle keyboard activation on badge button', async () => {
      ...
      const badgeButton = screen.getByRole('button', { name: /keyboard badge/i })
  ...
  describe('Accessibility', () => {
    ...
    it('should be focusable when rendered as button', () => {
      ...
      const badgeButton = screen.getByRole('button', { name: /focusable badge/i })
      badgeButton.focus()
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle very long text', () => {
      const longText = 'This is a very long badge text that should be handled properly by the component'
    ...
    it('should handle disabled state when asChild', () => {
      ...
      const badgeButton = screen.getByRole('button', { name: /disabled badge/i })
