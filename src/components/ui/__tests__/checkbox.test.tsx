...
describe('Checkbox Component - Click Tests', () => {
  ...
  it('should call onCheckedChange handler', async () => {
    ...
    customRender(<Checkbox aria-label="Callback Checkbox" onCheckedChange={mockOnCheckedChange} />)
    const checkbox = screen.getByRole('checkbox', { name: /callback checkbox/i })
  ...
  it('should render a disabled checkbox', async () => {
    const user = userEvent.setup()
    const mockOnCheckedChange = vi.fn()
    customRender(<Checkbox aria-label="Disabled Checkbox" disabled onCheckedChange={mockOnCheckedChange} />)
  ...
  it('should render an indeterminate checkbox', () => {
    customRender(<Checkbox aria-label="Indeterminate Checkbox" checked="indeterminate" />)
    const checkbox = screen.getByRole('checkbox', { name: /indeterminate checkbox/i })
  ...
  it('should have proper ARIA attributes for unchecked state', () => {
    ...
    const checkbox = screen.getByRole('checkbox', { name: /accessible checkbox/i })
  ...
  it('should have proper ARIA attributes for checked state', () => {
    ...
    const checkbox = screen.getByRole('checkbox', { name: /accessible checkbox checked/i })
    expect(checkbox).toHaveAttribute('aria-checked', 'true')
  })

  // Checkbox Custom Styling
  it('should apply custom className', () => {
    customRender(<Checkbox aria-label="Styled Checkbox" className="custom-checkbox-class" />)
  ...
  it('should handle Space key (may not toggle in all implementations)', async () => {
    ...
    const checkbox = screen.getByRole('checkbox', { name: /keyboard checkbox/i })
  ...
  it('should handle checkbox with custom props', () => {
    ...
    const checkbox = screen.getByRole('checkbox', { name: /custom props checkbox/i })
  ...
  it('should handle checkbox with value attribute', () => {
    customRender(<Checkbox aria-label="Valued Checkbox" value="checkbox-value" />)
