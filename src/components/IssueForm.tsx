        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid gap-2">
              ...
              <Select 
                value={formData.type} 
                onValueChange={(value) => setFormData(prev => ({ ...prev, type: value as IssueType }))}
              >
            ...
            <div className="grid gap-2">
              ...
              <Select 
                ...
                onValueChange={(value) => setFormData(prev => ({ ...prev, severity: value as IssueSeverity }))}
              >
            ...
            {showStatusField && (
              <div className="grid gap-2">
                ...
                <Select 
                  ...
                  onValueChange={(value) => setFormData(prev => ({ ...prev, status: value as IssueStatus }))}
                >
              ...
              <div className="grid gap-2">
                ...
                <div className="border-2 border-dashed rounded-lg p-6 text-center">
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <div>
                      <p className="text-sm font-medium">Upload files or take photos</p>
                      <p className="text-xs text-muted-foreground">
