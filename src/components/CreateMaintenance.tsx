...
export function CreateMaintenance({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!selectedAsset || !maintenanceType || !priority || !assignedTo || !scheduledDate) {
            ...
            <CardContent className="pt-6">
              <div className="flex items-start gap-2">
                ...
                <p className="text-sm text-blue-900">
                  Creating this maintenance task will be logged in the audit trail with your user information and timestamp.
                </p>
              </div>
            </CardContent>
          </Card>
