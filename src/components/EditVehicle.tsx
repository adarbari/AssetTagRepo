...
export function EditVehicle({ vehicleId, onBack, onVehicleUpdated }: EditVehicleProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const updatedVehicle = {
        id: vehicleId,
        name: vehicleName,
        type: vehicleTypes.find(t => t.value === vehicleType)?.label || vehicleType,
        licensePlate,
                    ...
                    <Select value={driver} onValueChange={setDriver}>
                      ...
                      <SelectContent>
                        {drivers.map((driverOption) => (
                          <SelectItem key={driverOption.value} value={driverOption.value}>
                            {driverOption.label}
                          </SelectItem>
                        ))}
                      </SelectContent>
