...
import { VehicleAssetPairing } from '../VehicleAssetPairing'
import { 
  render, 
  waitForAsync 
...
describe('VehicleAssetPairing Component', () => {
  ...
  describe('Rendering and Basic Functionality', () => {
    it('should render the vehicle-asset pairing page with header', () => {
      ...
      expect(screen.getByText('Manage asset loading with automatic expiration mechanisms')).toBeInTheDocument()
    })

    it('should render the Load Assets button', () => {
      render(<VehicleAssetPairing {...defaultProps} />)
      
      expect(screen.getByRole('button', { name: /load assets/i })).toBeInTheDocument()
    })
  ...
  describe('Asset Loading Dialog', () => {
    it('should open load assets dialog when Load Assets button is clicked', async () => {
      ...
      const loadAssetsButton = screen.getByRole('button', { name: /load assets/i })
    ...
    it('should allow setting expiration mechanism', async () => {
      ...
      const expirationSelect = screen.getByRole('combobox', { name: /expiration mechanism/i })
    ...
    it('should allow setting geofence action (enter/exit)', async () => {
      ...
      const actionSelect = screen.getByRole('combobox', { name: /geofence action/i })
    ...
    it('should allow toggling auto-unload', async () => {
      ...
      const autoUnloadSwitch = screen.getByRole('switch', { name: /auto-unload/i })
  ...
  describe('Accessibility', () => {
    ...
    it('should maintain keyboard navigation', async () => {
      ...
      await user.tab()
      expect(document.activeElement).toBe(screen.getByPlaceholderText(/search vehicles/i))
    })
  })
