...
describe('AssetMap Component', () => {
  ...
  describe('Rendering and Basic Functionality', () => {
    it('should render the live map with header', () => {
      ...
      expect(screen.getByText('Real-time location tracking with OpenStreetMap')).toBeInTheDocument()
    })
  ...
  describe('Asset Interaction', () => {
    ...
    it('should call onTrackHistory when track history is requested', async () => {
      ...
      const trackButton = screen.getByRole('button', { name: /track history/i })
      if (trackButton) {
  ...
  describe('Violation Mode', () => {
    it('should render violation mode when violationMode is true', () => {
      ...
      expect(screen.getByText('Showing assets outside their designated geofence boundaries')).toBeInTheDocument()
    })
  ...
  describe('Asset Highlighting', () => {
    ...
    it('should call onClearHighlight when clear highlight is requested', async () => {
      ...
      render(<AssetMap {...defaultProps} highlightAsset={highlightedAsset} onClearHighlight={vi.fn()} />)
  ...
  describe('Accessibility', () => {
    ...
    it('should maintain keyboard navigation', async () => {
      ...
      await user.tab()
      expect(document.activeElement).toBe(screen.getByPlaceholderText(/search assets/i))
    })
  })
