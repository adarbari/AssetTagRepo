...
vi.mock('../../data/mockData', () => ({
  mockSites: [
    ...
    },
    {
      ...
      assets: 75,
      status: 'maintenance',
      coordinates: { lat: 32.7767, lng: -96.7970, radius: 300 },
      manager: 'Jane Doe',
      phone: '(555) 987-6543',
...
describe('Sites Component', () => {
  ...
  describe('Rendering and Basic Functionality', () => {
    it('should render the sites page with header and stats', () => {
      ...
      expect(screen.getByText('Manage physical locations and boundaries')).toBeInTheDocument()
  ...
  describe('Filter Functionality', () => {
    ...
    it('should filter sites by asset count range', async () => {
      ...
      const assetSelect = screen.getByRole('combobox', { name: /asset count/i })
