...
describe('Maintenance Component', () => {
  ...
  describe('Tasks Tab', () => {
    ...
    it('should filter tasks by search term', async () => {
      ...
      expect(screen.getByText('Excavator CAT 320')).toBeInTheDocument()
      expect(screen.queryByText('Delivery Truck F-350')).not.toBeInTheDocument()
    })
  ...
  describe('Predictive Alerts Tab', () => {
    ...
    it('should allow dismissing predictive alerts', async () => {
      ...
      const { dismissPredictiveAlert } = await import('../../services/maintenanceService')
  ...
  describe('Task Actions', () => {
    it('should allow starting a task', async () => {
      ...
      const { updateMaintenanceTask } = await import('../../services/maintenanceService')
    ...
    it('should allow editing a task', async () => {
      ...
      const { useNavigation } = await import('../../contexts/NavigationContext')
  ...
  describe('Error Handling', () => {
    it('should handle data loading errors gracefully', async () => {
      const { fetchMaintenanceTasks } = await import('../../services/maintenanceService')
      vi.mocked(fetchMaintenanceTasks).mockRejectedValueOnce(new Error('Failed to load'))
    ...
    it('should handle task update errors', async () => {
      const user = userEvent.setup()
      const { updateMaintenanceTask } = await import('../../services/maintenanceService')
      vi.mocked(updateMaintenanceTask).mockRejectedValueOnce(new Error('Update failed'))
