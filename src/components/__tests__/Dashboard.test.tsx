...
describe('Dashboard Component', () => {
  ...
  describe('Rendering and Basic Functionality', () => {
    it('should render the dashboard with header', async () => {
      ...
      expect(screen.getByText('Real-time asset tracking overview')).toBeInTheDocument()
    })
    ...
    it('should render all main sections', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('Asset & Location Overview')).toBeInTheDocument()
  ...
  describe('Interactive Elements', () => {
    it('should call onViewChange when Total Assets card is clicked', async () => {
      ...
      const totalAssetsCard = screen.getByText('Total Assets').closest('[role="button"]')
      if (totalAssetsCard) {
    ...
    it('should call onViewChange when Active Locations card is clicked', async () => {
      ...
      const activeLocationsCard = screen.getByText('Active Locations').closest('[role="button"]')
    ...
    it('should call onNavigateToAlerts when alerts card is clicked', async () => {
      ...
      const alertsCard = screen.getByText('Active Alerts').closest('[role="button"]')
      if (alertsCard) {
    ...
    it('should call onViewChange when maintenance card is clicked', async () => {
      ...
      const maintenanceCard = screen.getByText('Maintenance Due').closest('[role="button"]')
      if (maintenanceCard) {
  ...
  describe('Data Loading and Error Handling', () => {
    it('should handle data loading errors gracefully', async () => {
      const { getDashboardStats } = await import('../../data/mockDashboardData')
      vi.mocked(getDashboardStats).mockRejectedValueOnce(new Error('Failed to load'))
