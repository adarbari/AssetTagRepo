...
import type { ConfigurationInspection, NotificationPreferences } from "../../types/notificationConfig";
...
export function ConfigurationInspector({
  ...
  const [inspection, setInspection] = useState<ConfigurationInspection | null>(null);
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <Card className="p-4">
            ...
            <div className="grid grid-cols-2 gap-3 mt-4">
              {Object.entries(effectiveConfig.preferences.channels).map(([channel, config]) => (
          ...
          <Card className="p-4">
            ...
            {effectiveConfig.inheritanceChain.length === 1 && (
              <p className="text-muted-foreground mt-2">
                No overrides configured. Using default {effectiveConfig.source.level}-level settings.
              </p>
            )}
          </Card>
        </div>
        ...
        <Card className="p-4 bg-blue-50 border-blue-200">
          <div className="flex gap-3">
            ...
            <div className="space-y-2">
              <p>
                <strong>How it works:</strong> Notification settings inherit from User → Site → Asset.
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              View which notification settings are being applied for {entityName}
            </DialogDescription>
          </DialogHeader>
