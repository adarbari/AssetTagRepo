...
export function Reports() {
  ...
  const totalTheftPrevention = costSavings.reduce((sum, m) => sum + m.theftPrevention, 0);
  const totalLaborSavings = costSavings.reduce((sum, m) => sum + m.laborSaved, 0);
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={utilization}>
                ...
                <Tooltip />
                <Legend />
                <Bar dataKey="utilization" fill="hsl(var(--chart-1))" name="Utilized %" />
