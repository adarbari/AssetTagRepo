...
describe('useAsyncData', () => {
  ...
  describe('Basic Functionality', () => {
    ...
    it('should return initial state with loading false when immediate is false', () => {
      ...
      const { result } = renderHook(() => useAsyncData(mockFetcher, { immediate: false }))
...
describe('useAsyncDataAll', () => {
  ...
  describe('Basic Functionality', () => {
    ...
    it('should return initial state with loading false when immediate is false', () => {
      ...
      const { result } = renderHook(() => useAsyncDataAll(mockFetchers, { immediate: false }))
  ...
  describe('Complex Data Structures', () => {
    it('should handle complex nested data', async () => {
      const mockComplexData = {
        assets: [
          { id: 1, name: 'Asset 1', location: { lat: 40.7128, lng: -74.0060 } },
        ],
        sites: [
          { id: 1, name: 'Site 1', assets: [1] },
        ],
        metadata: {
          totalAssets: 1,
          totalSites: 1,
