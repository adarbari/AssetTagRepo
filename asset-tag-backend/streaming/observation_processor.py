...
class ObservationProcessor:
    ...
    async def _store_observation(self, db: AsyncSession, observation_data: Dict[str, Any]):
        ...
        try:
            ...
            logger.debug(f"Stored observation for asset {asset_id} from gateway {gateway_id}")
    ...
    async def _update_asset_battery(self, db: AsyncSession, observation_data: Dict[str, Any]):
        """Update asset battery level"""
        try:
            battery_level = observation_data.get('battery_level')
