...
from modules.geofences.geofence_evaluator import GeofenceEvaluator
...
class TestGeofenceEvaluator:
    """Test GeofenceEvaluator functionality"""
    ...
    def test_evaluate_geofence_entry(self):
        ...
        result = evaluator.evaluate_geofence_event(
            geofence, previous_location, current_location
        )
    ...
    def test_multiple_geofences(self):
        ...
        events = evaluator.evaluate_all_geofences(
            geofences, previous_location, current_location
        )
