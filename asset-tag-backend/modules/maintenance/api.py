...
from modules.maintenance.schemas import MaintenanceCreate, MaintenanceUpdate, MaintenanceResponse
...
async def get_asset_maintenance_history(
    ...
    try:
        ...
        ).order_by(MaintenanceRecord.scheduled_date.desc()).limit(limit)
        ...
        return [
            {
                ...
                "estimated_duration_hours": float(record.estimated_duration_hours) if record.estimated_duration_hours else None,
