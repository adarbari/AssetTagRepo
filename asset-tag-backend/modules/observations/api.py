...
from modules.observations.schemas import (
    ...
    ObservationBatchCreate, ObservationBatchUpdate, ObservationBatchResponse,
    ObservationStatsResponse, ObservationBulkCreate, ObservationBulkResponse
)
...
async def get_observation_batch(
    batch_id: str,
    db: AsyncSession = Depends(get_db)
):
