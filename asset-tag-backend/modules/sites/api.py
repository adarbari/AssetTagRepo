...
from modules.sites.models import Site, Personnel, PersonnelActivity
from modules.sites.schemas import (
    SiteCreate, SiteUpdate, SiteResponse, SiteWithAssetsResponse,
    PersonnelCreate, PersonnelUpdate, PersonnelResponse, PersonnelActivityResponse
)
    ...
    try:
        ...
        existing = await db.execute(
            select(Site).where(
                ...
                Site.organization_id == "00000000-0000-0000-0000-000000000000"  # Default org
            )
        )
