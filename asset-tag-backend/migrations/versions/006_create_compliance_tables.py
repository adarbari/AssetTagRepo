...
def upgrade():
    ...
    op.create_index('idx_compliance_org_type', 'compliance', ['organization_id', 'compliance_type'])
    op.create_index('idx_compliance_org_status', 'compliance', ['organization_id', 'status'])
    op.create_index('idx_compliance_org_due_date', 'compliance', ['organization_id', 'due_date'])
    ...
    op.create_table('compliance_checks',
        ...
        sa.ForeignKeyConstraint(['compliance_id'], ['compliance.id'], ),
        sa.ForeignKeyConstraint(['organization_id'], ['organizations.id'], ),
        sa.PrimaryKeyConstraint('id')
    )
    
    # Create indexes for compliance_checks table
    op.create_index('idx_compliance_check_compliance', 'compliance_checks', ['compliance_id', 'check_date'])
