...
def upgrade():
    ...
    op.create_table('notification_configs',
        ...
        sa.Column('sms_phone_numbers', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column('sms_verified', sa.Boolean(), nullable=True),
        sa.Column('push_enabled', sa.Boolean(), nullable=True),
        sa.Column('push_devices', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        ...
        sa.Column('alert_types', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    ...
    op.create_index('idx_notification_config_level_entity', 'notification_configs', ['level', 'entity_id'])
    op.create_index('idx_notification_config_org_level', 'notification_configs', ['organization_id', 'level'])
    ...
    op.create_index('idx_notification_log_recipient', 'notification_logs', ['recipient_user_id', 'created_at'])
    op.create_index('idx_notification_log_status', 'notification_logs', ['delivery_status', 'created_at'])
    op.create_index('idx_notification_log_type', 'notification_logs', ['notification_type', 'created_at'])
    op.create_index('idx_notification_log_entity', 'notification_logs', ['related_entity_type', 'related_entity_id'])
    ...
    op.create_index('idx_notification_template_type_channel', 'notification_templates', ['template_type', 'channel'])
    op.create_index('idx_notification_template_org_name', 'notification_templates', ['organization_id', 'name'])
...
def downgrade():
    ...
    # Drop indexes
    op.drop_index('idx_notification_template_org_name', table_name='notification_templates')
    op.drop_index('idx_notification_template_type_channel', table_name='notification_templates')
    ...
    op.drop_index('idx_notification_config_org_level', table_name='notification_configs')
    op.drop_index('idx_notification_config_level_entity', table_name='notification_configs')
