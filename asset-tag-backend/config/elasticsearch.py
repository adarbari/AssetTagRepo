...
class ElasticsearchManager:
    ...
    async def index_document(self, index_type: str, document_id: str, document: Dict[str, Any]) -> bool:
        """Index a document"""
        try:
            client = await self._get_client()
    ...
    async def update_document(self, index_type: str, document_id: str, document: Dict[str, Any]) -> bool:
        """Update a document"""
        try:
            client = await self._get_client()
            index_name = self.indices.get(index_type)
