...
class ModelServer:
    ...
    async def initialize_models(self):
        ...
        try:
            ...
            location_model_path = os.path.join(self.model_path, 'location_predictor.joblib')
            maintenance_model_path = os.path.join(self.model_path, 'maintenance_predictor.joblib')
    ...
    async def train_location_model(self, asset_id: str, days_back: int = 30) -> Dict[str, Any]:
        ...
        try:
            ...
            for row in result.fetchall():
                historical_data.append({
                    ...
                    'distance_from_previous': float(row.distance_from_previous or 0),
            ...
            # Save the model
            model_path = os.path.join(self.model_path, f'location_predictor_{asset_id}.joblib')
    ...
    async def train_maintenance_model(self, organization_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            for row in result.fetchall():
                ...
                asset_historical = await self._get_asset_historical_data(str(row.asset_id))
            ...
            # Save the model
            model_path = os.path.join(self.model_path, f'maintenance_predictor_{organization_id}.joblib')
    ...
    async def predict_location(self, asset_id: str, steps_ahead: int = 7) -> Dict[str, Any]:
    ...
    async def get_model_status(self) -> Dict[str, Any]:
        ...
        return {
            'location_predictor': {
                ...
                'model_path': os.path.join(self.model_path, 'location_predictor.joblib')
            },
            'maintenance_predictor': {
                'trained': self.maintenance_predictor.is_trained,
                'model_path': os.path.join(self.model_path, 'maintenance_predictor.joblib')
            },
