...
class MLflowClient:
    ...
    def start_run(self, experiment_name: str, run_name: Optional[str] = None) -> mlflow.ActiveRun:
    ...
    def get_experiment_runs(self, experiment_name: str, limit: int = 10) -> List[Dict[str, Any]]:
...
# Utility functions
def log_anomaly_detection_model(model, metrics: Dict[str, float], params: Dict[str, Any]):
...
def log_location_prediction_model(model, metrics: Dict[str, float], params: Dict[str, Any]):
